    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 max-w-md mb-4">
              CTO, développeur senior et product manager. J'aide startups et entreprises à transformer leurs idées en applications scalables.
            </p>
            <div className="flex space-x-4">
              <a
                href="https://linkedin.com/in/michaelramassamy"
                target="_blank"
              ...
              {/* <a
                href="mailto:contact@cosmike.com"
                className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-accent-600 transition-colors duration-300"
                aria-label="Email"
              >
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/realisations" className="hover:text-accent-400 transition-colors">
                  Réalisations
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              {/* <li>
                <a href="mailto:contact@cosmike.com" className="hover:text-accent-400 transition-colors">
                  contact@cosmike.com
                </a>
              </li> */}
            </ul>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-500 text-sm">
          <p className="mb-2">&copy; {currentYear} Cosmike. Tous droits réservés.</p>
